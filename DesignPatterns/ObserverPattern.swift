...
private final class NewsChannel: Observer, NewsObserver {
...
private final class StockTrader: StockObserver {
...
protocol ProgressObserver: AnyObject {
...
private final class ProgressBar: ProgressObserver {
    private let name: String
...
private final class ProgressLogger: ProgressObserver {
    func progressUpdated(_ progress: Double, task: String) {
...
private final class UserActivityLogger: EventObserver {
...
private final class SecurityMonitor: EventObserver {
    func handleEvent(_ event: Event) {
