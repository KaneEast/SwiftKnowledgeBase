...
// MARK: - Protocols
fileprivate protocol FileDownloadDelegate: AnyObject {
...
fileprivate protocol UserValidationDelegate: AnyObject {
...
fileprivate class FileDownloader {
...
fileprivate class MockDownloadView: FileDownloadDelegate {
...
fileprivate class MockValidationView: UserValidationDelegate {
    private let viewName: String
...
// MARK: - Usage Example
fileprivate class DelegationPatternExample {
    static func run() {
